...
namespace :foreman do
  ...
  task :export do
    on roles(:app) do
        ...
        execute "sudo touch /home/deploy/apps/foreman4rails/current/log/foreman-log.log"
        execute "sudo chmod 777 /home/deploy/apps/foreman4rails/current/log/foreman-log.log"
        execute "/home/deploy/.rvm/bin/rvm all do foreman export upstart /etc/init --log /home/deploy/apps/foreman4rails/current/log/foreman-log.log --procfile /home/deploy/apps/foreman4rails/current/Procfile --app=#{fetch(:application)} --user=#{fetch(:user)}"
