...
namespace :foreman do
  ...
  task :restart do
    on roles(:app) do
        execute "sudo service foreman4rails-foreman4rails-1 stop"
        execute "sudo service foreman4rails-foreman4rails-1 start"
        execute "sudo service foreman4rails-foreman4rails-1 restart"
    end
  end
end
