...
namespace :foreman do
  ...
  task :export do
    on roles(:app) do
        ...
        execute "/home/deploy/.rvm/bin/rvm all do foreman export upstart /etc/init --log /home/deploy/apps/foreman4rails/current/log --procfile /home/deploy/apps/foreman4rails/current/Procfile --app=#{fetch(:application)} --user=#{fetch(:user)}"
